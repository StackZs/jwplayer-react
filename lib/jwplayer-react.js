    ...
    class u extends t().Component {
      constructor(e) {
        super(e),
          ...
          (this.player = null),
          (this.didMountCallback = e.didMountCallback),
          (this.willUnmountCallback = e.willUnmountCallback),
          (this.id = e.id || (l++, `jwplayer-${l}`)),
          (this.onHandler = null),
      ...
      shouldComponentUpdate(e) {
        return !(
          !this.player ||
          (this.didOnEventsChange(e) && (this.updateOnEventListener(e), 1))
        );
      }
      ...
      createPlayer() {
        const { config: e, ref: t } = this,
          ...
          a = t.current;
        return window.jwplayer(a.id).setup(r);
      }
      didOnEventsChange(e) {
        const t = (e) => e.match(n),
        ...
        return (
          a.length !== r.length ||
          a.some((t, a) => r[a] !== t || e[t] !== this.props[t])
        );
      }
      createEventListeners() {
        Object.keys(this.props).forEach((e) => {
          ...
          (this.onHandler = p(this.props)),
          this.player.on(i, this.onHandler);
      }
      updateOnEventListener(e) {
        this.onHandler && this.player.off(i, this.onHandler),
          (this.onHandler = p(e)),
          this.player.on(i, this.onHandler);
      }
      render() {
